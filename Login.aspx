<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="UniConnWeb.Login" %>
...
<body>
        <div class="loginbox">
            ...
            <form runat="server" >
                ...
                <asp:DropDownList ID="DropDownUser" runat="server" OnSelectedIndexChanged="DropDownUser_SelectedIndexChanged" >
                ...
                <asp:LinkButton Text="Forgot your password?" CssClass="btnsforget" runat="server"  ID="btnsforgot" OnClick="btnsforgot_Click" ForeColor="White" />
            </form>
        </div>
</body>
</html>
