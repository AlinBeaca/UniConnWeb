...
namespace UniConnWeb
{
    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            OracleDataAdapter sda = new OracleDataAdapter("select * from Userul where Utilizator='" + txtemail.Text + "' and Parola='" + Encrypt(txtpass.Text) + "'and Rol= '" + DropDownUser.SelectedItem.ToString() + "'", conn);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    Server.Transfer("Homepage_profesor.aspx");
                }
                else if (DropDownUser.SelectedIndex == 2)
                {
                    Server.Transfer("Homepage_student.aspx");
                }
                else if (DropDownUser.SelectedIndex == 3)
                {
                    Response.Redirect("Homepage_secretara.aspx");
                }
        ...
        {
            Response.Redirect("Send_code.aspx");
