<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Materii.aspx.cs" Inherits="UniConnWeb.Materii" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="width:1590px">
            ...
            <asp:Menu ID="Menu8" runat="server" ForeColor="White" Orientation="Horizontal"  >
                <Items>
        ...
        <div>
          ...
          <br />
             <asp:GridView ID="GridView3" runat="server"  AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" Height="16px" HorizontalAlign="Center" OnSelectedIndexChanged="GridView3_SelectedIndexChanged">
                <Columns>
                     
                     <asp:BoundField DataField="Nume_materii" HeaderText="Nume materie" />
                    <asp:BoundField DataField="Nume" HeaderText="Nume profesor" />
                    <asp:BoundField DataField="Prenume" HeaderText="Prenume profesor" />
                    <asp:BoundField DataField="Functie_didactica" HeaderText="Functie didactica" />
                    <asp:BoundField DataField="E_mailul" HeaderText="E-mail" />
                </Columns>
